      ...
      <div className="relative max-w-7xl mx-auto px-6 md:px-12 py-20 md:py-32">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            <div className="aspect-square bg-gradient-to-br from-primary/10 to-accent/10 rounded-lg flex items-center justify-center border-2 border-border shadow-lg">
              <div className="text-center p-8">
                <div className="w-48 h-48 mx-auto bg-card rounded-lg border-2 border-card-border flex items-center justify-center mb-4 shadow-md">
